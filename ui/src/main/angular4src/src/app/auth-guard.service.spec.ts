...
import { codeInfoRouter } from "./code-info/code-info.router";
...
class adal4ServiceStub extends Adal4Service {}
  ...
  const subscriptionServiceStub: SubscriptionServiceStub = new SubscriptionServiceStub();
    ...
    TestBed.configureTestingModule({
      ...
      providers: [{provide: IdprestapiService, useValue: idprestapiServiceStub},
          ...
          IdpService, IDPEncryption, Adal4Service, KeycloakService, AuthGuardService,
  ...
  beforeEach(() => {
  service = new AuthGuardService(router, cookieService, idprestapiService, adal4Service, idpdataService, keycloakService);
