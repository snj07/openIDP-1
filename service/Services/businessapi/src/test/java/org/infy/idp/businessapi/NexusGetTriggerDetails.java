...
public class NexusGetTriggerDetails {
	...
	public void getBigdataModules(){
		Gson g=new Gson();
		String idpJson="{\"basicInfo\":{\"applicationName\":\"Awesome_App\",\"pipelineName\":\"Big_Data\",\"buildServerOS\":\"windows\",\"engine\":\"Jenkins Workflow\",\"buildInterval\":{\"pollSCM\":\"off\",\"buildInterval\":\"\",\"buildIntervalValue\":\"0\",\"buildAtSpecificInterval\":\"off\",\"event\":[{\"type\":\"--Select--\",\"hour\":\"00\",\"minute\":\"00\"}]},\"additionalMailRecipients\":{\"applicationTeam\":\"\",\"emailIds\":\"\"},\"pipelineStatus\":\"edit\"},\"code\":{\"category\":\"Standard\",\"technology\":\"bigData\",\"scm\":[{\"type\":\"git\",\"url\":\"http://xyz.com/idp_oss/BigData_Proj_IDP.git\",\"userName\":\"idp_oss\",\"password\":\"pwd1234+\",\"repositoryBrowser\":\"gitLab\",\"browserUrl\":\"http://xyz.com/\",\"projectName\":\"\",\"branch\":\"master\",\"projPath\":\"\",\"moduleName\":\"\",\"clearcaseType\":\"\",\"vobName\":\"\",\"snapshotViewName\":\"\",\"configSpec\":\"\",\"developmentStreamName\":\"\",\"buildConfiguration\":\"\",\"buildDefinition\":\"\",\"repositoryWorkspace\":\"\",\"projArea\":\"\",\"port\":\"\",\"version\":\"9\",\"exclude\":\"\",\"proxy\":\"\",\"proxyPort\":\"\",\"appRepo\":\"on\",\"deployRepo\":\"\",\"testRepo\":\"\"}],\"jobParam\":[],\"buildScript\":[{\"tool\":\"\"},{\"tool\":\"\"},{}],\"subApplication\":\"\"},\"buildInfo\":{\"buildtool\":\"bigData\",\"artifactToStage\":{\"artifact\":\"pig/,hive/,scala/,**/*.txt,**/*.sql\",\"artifactRepo\":{\"repoURL\":\"idp_oss:8081\",\"repoName\":\"idp_Nexus\",\"repoUsername\":\"admin\",\"repoPassword\":\"admin123\"},\"artifactRepoName\":\"nexus\"},\"castAnalysis\":{},\"modules\":[{\"moduleName\":\"\",\"codeAnalysis\":[],\"unitTesting\":\"off\",\"sqlFilesPackage\":\"\",\"connectionName\":\"\",\"testSuite\":\"\",\"pigProjectName\":\"BigData_Proj_IDP/PIG_UnitTestProject\",\"pigPomPath\":\"BigData_Proj_IDP/PIG_UnitTestProject/pom.xml\",\"pigUT\":\"on\",\"hiveProjectPath\":\"BigData_Proj_IDP/hiveunit\",\"hivePomPath\":\"BigData_Proj_IDP/hiveunit/pom.xml\",\"hiveUT\":\"on\",\"scalaProjectName\":\"BigData_Proj_IDP/ScalaBuild\",\"scalaPomPath\":\"BigData_Proj_IDP/ScalaBuild/pom.xml\",\"scalaCC\":\"on\"}],\"postBuildScript\":{\"dependentPipelineList\":[]}},\"deployInfo\":{\"deployEnv\":[{\"envName\":\"Env1\",\"envFlag\":\"on\",\"scriptType\":\"\",\"deploySteps\":[{\"stepName\":\"step1\",\"deployOS\":\"\",\"runScript\":{\"scriptType\":\"\"},\"deployToContainer\":{\"containerName\":\"\",\"updateDB\":\"\",\"rollbackStrategy\":\"\",\"dbDeployPipelineList\":[]},\"deployDatabase\":{\"restorusername\":\"\",\"restorpassword\":\"\",\"dbusername\":\"\",\"dbpassword\":\"\",\"script\":\"\"},\"scalaServerName\":\"idp_oss\",\"scalaUsername\":\"idp_oss\",\"scalaPassword\":\"idp_oss\",\"scalaDir\":\"sarojini\",\"scalaUip\":\"users.txt,transactions.txt\",\"scalaJfn\":\"ScalaBuild-0.0.1-SNAPSHOT.jar\",\"scalaMmn\":\"master\",\"scalaCfn\":\"main.scala.ExampleJob\",\"scalaOf\":\"myjob\",\"pigServerName\":\"idp_oss\",\"pigUsername\":\"idp_oss\",\"pigPassword\":\"idp_oss\",\"pigDir\":\"sarojini\",\"pigScr\":\"pigunittest.pig\",\"pigLocalMac\":\"on\",\"hiveServerName\":\"idp_oss\",\"hiveUsername\":\"idp_oss\",\"hivePassword\":\"idp_oss\",\"hiveDir\":\"sarojini\",\"hiveScr\":\"create_table.sql\"}]}]},\"testInfo\":{\"testEnv\":[{\"envName\":\"Env1\",\"envFlag\":\"off\"}]}}";
	    IDPJob idp=g.fromJson(idpJson, IDPJob.class);
	    String abc="{\"applicationName\":\"Awesome_App\",\"pipelineAdmins\":\"idp_oss\",\"releaseManager\":\"idp_oss\",\"slavesDetails\":[{\"labels\":\"Nexus_slave\",\"slaveName\":\"Nexus_slave\",\"buildServerOS\":\"windows\",\"workspacePath\":\"D:/NexusSlave\",\"slaveUsage\":\"both\",\"createNewSlave\":\"on\"}],\"developers\":\"idp_oss\",\"sapApplication\":\"off\",\"environmentOwnerDetails\":[{\"qa\":\"idp_oss\",\"environmentName\":\"DEV\",\"environmentOwners\":\"idp_oss,idp_oss\"},{\"environmentName\":\"Stage\",\"environmentOwners\":\"idp_oss\"},{\"environmentName\":\"Stage3\",\"environmentOwners\":\"idp_oss\"}],\"artifactToStage\":{\"artifactRepo\":{\"repoURL\":\"idp_oss:8081\",\"repoUsername\":\"admin\",\"repoPassword\":\"admin123\",\"repoName\":\"na\"},\"artifactRepoName\":\"na\"}}";
	    ApplicationInfo app=g.fromJson(abc, ApplicationInfo.class);
	    List<String> userEnvs=new ArrayList<>();
	    userEnvs.add("idp_oss");
	    Build build=testedObject.getBuildInfo( idp, "bigData", app,"idp_oss",userEnvs);
